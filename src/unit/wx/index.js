 ...
 */
const wx = window.wx
const wxInit = DbyPublic => {
  const WxApi = class WxApi extends DbyPublic {
    constructor () {
      super()
    ...
    /**
     * 初始化微信
     * @param {分享标题, 分享链接, 分享图标, 分享描述, 需要使用的JS接口列表} {title, link, imgUrl, desc, jsApiList, appId, debug, success, fail}
     */
