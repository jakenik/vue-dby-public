    ...
    <div v-show="visible" id="dby-message-bottom" @click.self="close">
      <div id="dby-message-bottom-tail">
        <div class="dby-message-bottom-action">
          <div class="dby-message-bottom-button dby-message-bottom-cancel" @click="close">{{cancelText}}</div>
          <div class="dby-message-bottom-button dby-message-bottom-confirm" @click="close">{{confirmText}}</div>
        </div>
        <slot></slot>
      </div>
    </div>
