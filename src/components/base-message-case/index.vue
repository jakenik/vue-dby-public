<template>
  <transition name="message-fade">
    <div v-show="visible" id="dby-message-case" @click.self="close();onChangeEmit(false);">
      <div class="dby-message-case-body">
        <div>
          <slot></slot>
        </div>
        <svg @click="close();onChangeEmit(false);" class="dby-message-case-close" t="1548229406836" viewBox="0 0 1024 1024" version="1.1"
        xmlns="http://www.w3.org/2000/svg" p-id="1105" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="30">
...
.dby-message-case-body{
  ...
  width: 14.4rem;
  min-height: 18.48rem;
  box-shadow: 0 0.13333rem 1.01333rem 0 rgba(0,0,0,.2);
}
.dby-message-case-close{
  position: absolute;
  bottom: 0%;
  left: 50%;
